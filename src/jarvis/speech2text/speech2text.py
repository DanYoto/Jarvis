...
class VoskRealtimeSTT:
    ...
    def _post_process_result(self, result: Dict) -> Dict:
        ...
        if (
            hasattr(self, "confidence_threshold")
    ...
    def stop_recognition(self):
        ...
        if (
            ...
            and threading.current_thread() is not self.processing_thread
        ):
...
def main():
    ...
    # Create STT instance
    stt = VoskRealtimeSTT(
        model_path=model_path, sample_rate=16000, callback=result_callback
    )
